...
EOF
    ...
    append_line_if_missing "${FREEDOS_CACHE_DIR}/FDCONFIG.SYS" "DEVICE=UDVD2.SYS /D:OS8CD001"
    append_line_if_missing "${FREEDOS_CACHE_DIR}/CONFIG.SYS" "LASTDRIVE=Z"
    append_line_if_missing "${FREEDOS_CACHE_DIR}/CONFIG.SYS" "DEVICE=UDVD2.SYS /D:OS8CD001"
