...
/* ============================================================
   COMPAT API (EXPECTED BY MAIN/INPUT)
============================================================ */
...
pub fn handle_key_input(_ch: char) -> bool {
    false
}

pub fn set_bounds(w: usize, h: usize) {
    set_displays(&[DisplayInfo {
        id: 0,
        x: 0,
        y: 0,
        w,
...
pub fn move_mouse(_dx: isize, _dy: isize) {
    invalidate();
}
...
pub fn render() {
    ...
    crate::framebuffer::draw_desktop();
    render_frame();
}
#[derive(Clone, Copy)]
...
pub fn set_displays(_list: &[DisplayInfo]) {
    invalidate();
}
